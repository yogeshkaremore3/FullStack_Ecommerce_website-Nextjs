...
const Footer = () => {
  ...
  <Link href="/">
      ...
      <Image src="/photo.png" alt="store" width={200} height={100}/>

     
      </Link>
      <p className="mt-2 text-sm text-gray-500 px-2">Wear the &lt;Tshirt/&gt;</p>
      <p className='text-sm text-gray-500 px-2'>Premium tshirts, hoodies, and apparals</p>
    </div>
  ...
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 Opencart.com — All Rights Reserved
      </p>
